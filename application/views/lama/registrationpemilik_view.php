...
<!-- end #header -->
	<!-- box Login -->
		...
		<form action="dream.htm" method="post">
		Email User	:
...
<div id="poptrox">
	...
	<div class="reg_form">
	<div class="form_title">Form Registrasi Pemilik Kost</div>
		<?php echo validation_errors('<p class="error">'); ?>
	<?php echo form_open("pemilik/registration"); ?>
		<p>
		...
		<p>
			...
			<?php echo '<input type="namaKost" name="namaKost" value = "'.$namaKost.'"/>'?>
		</p> 
		<p>
			<label for="alamat">Alamat:</label>
			<?php echo '<input type="alamat" name="alamat" value = "'.$alamat.'"/>'?>
		</p> 
		<p>
			<label for="rangeHarga">Range Harga Kost:</label>
			<?php echo '<input type="rangeHarga" name="rangeHarga" value = "'.$rangeHarga.'" />'?>
		</p> 
		<p>
			<label for="kuota">Kapasitas Kost:</label>
			<?php echo '<input type="kuota" name="kuota" value = "'.$kuota.'" />'?>
		</p> 
