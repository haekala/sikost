...
<!-- end #header -->
	...
	<div id="register">
		Belum punya account?
		<?php echo '<form action = "'.base_url().'index.php/user" method = "POST">'?>
		<input type="submit" value="register user"/>
		</form>
		<?php echo '<form action = "'.base_url().'index.php/pemilik" method = "POST">'?>
		<input type="submit" value="register pemilik kost"/>
		</form>
