...
<html lang="en">
  ...
  <body>
    ...
    <div class="well">
        <h2>Upload Images Kost siKost.com</h2>
	</div>
	

<?php echo $error;?>

<?php echo form_open_multipart('imageuploader/do_upload');?>

<input type="file" name="userfile" size="20" />
<input type="text" name="deskripsi" placeholder="deskripsi singkat"></input>
<br /><br />
...
<input type="submit" value="upload" />
           ...
           <footer class="well">
        <p><?php echo "2013 siKost.com<br>Fakultas Ilmu Komputer UI"; ?></p>
      </footer>
