...
<html lang="en">
  ...
  <body>
	...
	<?php } ?>
      ...
      <div class="hero-unit">
        <h2>Selamat registrasi anda berhasil!</h2>
        <p>Silakan login untuk menggunakan aplikasi siKost.com. Aplikasi ini sangat bermanfaat bagi setiap pengguna yang ingin melakukan pendaftaran dan pembayaran online sesuai dengan kost yang diinginkan.</p>
      </div>
