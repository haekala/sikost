    ...
    <div class="well">
        <h2>Registrasi Pemilik Kost siKost.com</h2>
            ...
            <form class="form-horizontal" method="post" action="<?php echo base_url()?>index.php/pemilik/registration">
				...
				<p>User harus mengikuti aturan dan ketentuan yang ditetapkan<br /> oleh pihak Sikost.  Aturan dan ketentuan dapat berubah sewaktu-waktu.  <br />
				Kerugian dan Penipuan oleh pihak pemilik kost bukanlah tanggung jawab Sikost.com. <br /> Segala bentuk pelanggaran dapat dikenai hukuman sesuai Undang-Undang <br> yang berlaku di Republik Indonesia</p>
                <div class="control-group">
                    <div class="controls">
